...
import { Brands, ProductLines } from "../../types/index";
interface Props {
  setClose: () => void;
  refresh: () => void;
}

export const AddProduct = ({ setClose, refresh }: Props) => {
    ...
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/80">
      <div className="bg-white dark:bg-gray-900 p-6 rounded-xl w-full max-w-6xl shadow-lg relative border border-gray-200 dark:border-white/[0.1] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleProduct}>
          ...
          <div className="flex gap-5 mb-4">
            <div className="w-1/2 max-w-1/2">
              <Switch label="Nổi bật sản phẩm" checked={form.hot} onChange={handleHotChange} />
            </div>
            <div className="w-1/2 max-w-1/2">
              <Switch label="Sản phẩm khuyến mãi" checked={form.isDiscount} onChange={handleDiscountChange} />
            </div>
          </div>
          <div className="flex gap-5 mb-4">
            <div className="w-1/2 max-w-1/2">
