...
export const AddBanner = ({ setClose, refresh }: Props) => {
  ...
  const handleBanner = async (e: FormEvent) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${API_URL}/api/banners`, form);
    ...
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/80">
      <div className="bg-white dark:bg-gray-900 p-6 rounded-xl w-full max-w-2xl shadow-lg relative border border-gray-200 dark:border-white/[0.1] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleBanner}>
          ...
          <div className="mb-4">
            <Label htmlFor="description">Mô tả banner</Label>
