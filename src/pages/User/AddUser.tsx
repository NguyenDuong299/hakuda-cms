...
export const AddUser = ({ setClose, refresh }: Props) => {
  ...
  const handleUser = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${API_URL}/api/users`, form);
        ...
        <form onSubmit={handleUser}>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) => {
                setSelectedProvince(form.address_province);
                setForm((prev) => ({ ...prev, addressProvinceCode: form.address_province }));
                setSelectedDistrict("");
                setSelectedWard("");
              }}
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setForm((prev) => ({ ...prev, addressDistrictCode: code }));
                setSelectedWard("");
              }}
              className="w-full p-2 border rounded"
            >
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setForm((prev) => ({ ...prev, addressWardCode: code }));
              }}
              className="w-full p-2 border rounded"
            >
          ...
          <div className="mb-4">
            ...
            <Input id="addressDetail" type="text" placeholder="Địa chỉ" name="address" value={form.addressDetail} onChange={onChange} />
          </div>
