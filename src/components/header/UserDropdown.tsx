  ...
  return (
    <div className="relative">
      <button onClick={toggleDropdown} className="flex items-center text-gray-700 dropdown-toggle dark:text-gray-400">
        ...
        <span className="block mr-1 font-medium text-theme-sm">{userCheck?.firstName}</span>
        <svg
      ...
      >
        <div>
          <span className="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{userCheck?.firstName}</span>
          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">{userCheck?.email}</span>
        </div>
